		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Scrivo'),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('beta'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Collaborative gaming meets writing improvisation'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
										...
										},
										{
											...
											_0: A2(
												_elm_lang$html$Html$a,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href('#join'),
														_1: {
															ctor: '::',
															_0: A2(_elm_lang$html$Html_Attributes$attribute, 'role', 'button'),
															_1: {ctor: '[]'}
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Join an existing game'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _user$project$Scrivo$view = function (model) {
	...
	switch (_p0.ctor) {
		...
		default:
			return _user$project$Scrivo$viewInitial;
	}
};
...
var _user$project$Scrivo$CreatingGame = {ctor: 'CreatingGame'};
...
var _user$project$Scrivo$initialModel = {
	...
	nameInput: '',
	history: {ctor: '[]'},
	gameState: _user$project$Scrivo$Intro
};
var _user$project$Scrivo$modelFromLocation = F2(
	function (model, location) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				history: {ctor: '::', _0: location, _1: model.history},
				gameState: function () {
					var _p1 = A2(_elm_lang$core$Debug$log, 'hash', location.hash);
					switch (_p1) {
						case '#new':
							return _user$project$Scrivo$CreatingGame;
						case '#join':
							return _user$project$Scrivo$JoiningGame;
						default:
							return _user$project$Scrivo$Intro;
					}
				}()
			});
	});
var _user$project$Scrivo$update = F2(
	function (msg, model) {
		var _p2 = msg;
		if (_p2.ctor === 'UrlChange') {
			return {
				ctor: '_Tuple2',
				_0: A2(_user$project$Scrivo$modelFromLocation, model, _p2._0),
...
var _user$project$Scrivo$SetGameState = function (a) {
	return {ctor: 'SetGameState', _0: a};
};
var _user$project$Scrivo$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Scrivo$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Scrivo$UrlChange,
	{
		init: function (location) {
			return {ctor: '_Tuple2', _0: _user$project$Scrivo$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
		},
		view: _user$project$Scrivo$view,
		update: _user$project$Scrivo$update,
...
var Elm = {};
Elm['Scrivo'] = Elm['Scrivo'] || {};
if (typeof _user$project$Scrivo$main !== 'undefined') {
    _user$project$Scrivo$main(Elm['Scrivo'], 'Scrivo', {"types":{"unions":{"Scrivo.GameState":{"args":[],"tags":{"Playing":[],"Intro":[],"JoiningGame":[],"CreatingGame":[]}},"Scrivo.Msg":{"args":[],"tags":{"UrlChange":["Navigation.Location"],"SetGameState":["Scrivo.GameState"]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Scrivo.Msg"},"versions":{"elm":"0.18.0"}});
}
